...
link: stow
	...
	# Pre-create directories so stow creates file-level symlinks instead of
	# directory-level symlinks. This prevents runtime files (logs, caches, etc.)
	# generated by these tools from appearing in the dotfiles repo.
